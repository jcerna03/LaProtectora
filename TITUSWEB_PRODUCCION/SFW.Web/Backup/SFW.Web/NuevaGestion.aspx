...
<head runat="server">
    ...
    <%--    <script type="text/javascript">
        function Modal() {
            $('#iModalDataEjeCuenta').modal('hide');
...
<body>
                ...
                <div class="panel-body">
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            ...
                            <div class="col-md-6 text-right">
                                <div class="btn-group">
                                    <%--                                    <asp:LinkButton ID="LinkButton11" runat="server" class="btn btn-default btn-sm" onclick="lnkGuardar_Click" >
                                        <i class="fa fa-plus fa-1x text-blue"></i>&nbsp;Nuevo
                                    </asp:LinkButton>  --%>
                    ...
                    <div class="row-eq-height">
                        <div class="panel panel-default col-md-2">
                            ...
                            <div class="panel-body form-horizontal">
                                <div class="form-group-sm">
                                    <asp:HiddenField ID="hfLlamada" runat="server" />
                                    <div class="table-responsive centrar">
                                        <asp:GridView ID="gvTipoLlamada" runat="server" class="table table-bordered table-condensed input-sm"
                                            AutoGenerateColumns="False" AllowPaging="True" DataKeyNames="ID,DESCRIP" ShowHeader="False"
                                            OnRowCommand="gvTipoLlamada_RowCommand" OnRowDataBound="gvTipoLlamada_RowDataBound">
                                            <Columns>
                            ...
                            <div class="panel-body form-horizontal">
                                <div class="form-group-sm">
                                    <div class="form-inline">
                                        <asp:HiddenField ID="hftipEmisor" runat="server" />
                                        <asp:HiddenField ID="hfidEmi" runat="server" />
                                        <asp:HiddenField ID="hfnombreemi" runat="server" />
                                        <asp:HiddenField ID="hfDerivadoEjecutivo" runat="server" />
                                        <asp:HiddenField ID="hdfDatosAdicionales" runat="server" />
                                    </div>
                                    <div class="table-responsive centrar">
                        ...
                        <div class="panel panel-default col-md-6">
                            <div class="panel-heading row">
                                <label class="control-label input-sm text-white">
                                    (*)Asegurado / Cliente:</label>
                                <asp:Label ID="lblAsegura" runat="server" Text="" class="text-white input-sm text-uppercase"></asp:Label>
                            </div>
                            <div class="panel-body form-horizontal">
                                <div class="form-group-sm">
                                    <div class="form-inline">
                                        <!--hidden-->
                                        <asp:HiddenField ID="hftipAseg" runat="server" />
                                        <asp:HiddenField ID="hfidAseg" runat="server" />
                                        <asp:HiddenField ID="hfcodtitula" runat="server" />
                                    ...
                                    <div class="centrar" id="generaldiv">
                                        <asp:GridView ID="gvDatosAfi" runat="server" class="table table-bordered table-condensed input-sm"
                                            AutoGenerateColumns="false" DataKeyNames="cod_cliente2,cod_titula" OnRowCommand="gvDatosAfi_RowCommand">
                                            <Columns>
                                ...
                                <div class="form-group-sm">
                                    ...
                                    <div class="table-responsive centrar">
                                        <asp:GridView ID="gvSubGestion" runat="server" class="table table-bordered table-condensed input-sm"
                                            AutoGenerateColumns="False" AllowPaging="True" PageSize="10" DataKeyNames="ID"
                                            ShowHeader="False" OnRowCommand="gvSubGestion_RowCommand" OnRowDataBound="gvSubGestion_RowDataBound">
                                            <Columns>
                                                <asp:BoundField DataField="ID" HeaderText="" Visible="False" />
                                                <asp:ButtonField CommandName="Seleccionar" DataTextField="DESCRIP" HeaderText="" />
                                            </Columns>
                        ...
                        <div class="panel panel-default col-md-6">
                                ...
                                <div class="col-md-6 text-right">
                                    <div class="form-inline">
                                        <asp:LinkButton ID="lnkAgregar" runat="server" class="btn btn-default btn-sm" OnClick="lnkAgregar_Click">
                                            <i class="fa fa-plus fa-1x text-blue"></i>&nbsp;Agregar
                                        </asp:LinkButton>
                            ...
                            <div class="panel-body form-horizontal">
                                <div class="form-group-sm">
                                    <div class="table-responsive centrar">
                                        ...
                                        <asp:GridView ID="gvGestionResueltos" runat="server" class="table table-bordered table-condensed input-sm"
                                            AutoGenerateColumns="false" OnRowCommand="gvGestionResueltos_RowCommand" DataKeyNames="NRO,ORIGEN,DESCRIPORIGEN,IDSALIENTE,DESCRIPSALIENTE,DESCRIP_CONTACTO,RESPUESTA,OBS,USU_REG">
                                            <Columns>
                                                ...
                                                <asp:ButtonField CommandName="ELIMINAR" ButtonType="Link" Text='<i class="fa fa-minus fa-1x text-white"></i>'
                                                ...
                                                <asp:BoundField DataField="RESPUESTA" HeaderText="RESPT." />
                                        ...
                                        <asp:GridView ID="gvGestionResueltos2" runat="server" class="table table-bordered table-condensed input-sm"
                                            AutoGenerateColumns="false" DataKeyNames="ID,NRO,ORIGEN,DESCRIPORIGEN,IDSALIENTE,DESCRIPSALIENTE,DESCRIP_CONTACTO,RESPUESTA,OBS,USU_REG"
                                            OnRowCommand="gvGestionResueltos2_RowCommand">
                                            <Columns>
                                                <asp:ButtonField CommandName="ACTUALIZAR" ButtonType="Link" Text='<i class="fa fa-edit fa-1x text-white"></i>'
                                                    ControlStyle-CssClass="btn btn-info btn-sm" HeaderText="Actualizar" />
                                                <asp:ButtonField CommandName="ELIMINAR" ButtonType="Link" Text='<i class="fa fa-minus fa-1x text-white"></i>'
                                ...
                                <div class="form-group-sm">
                                    ...
                                    <div class="form-inline">
                                        <asp:TextBox ID="txtContactoNom" runat="server" CssClass="form-control input-sm"
                                            placeholder="Nombres y Apellidos" Width="50%"></asp:TextBox>
                                        <asp:TextBox ID="txtContactoTel" runat="server" CssClass="form-control input-sm"
                                            placeholder="Teléfono" Width="20%"></asp:TextBox>
                                        <asp:TextBox ID="txtContactoCo" runat="server" CssClass="form-control input-sm" placeholder="Correo"
                                            Width="20%"></asp:TextBox>
                                    </div>
                                </div>
                                <%--                                <div class="form-group-sm">
                                    <label class="text-blue input-sm">Teléfono</label>
                                    
                                </div>
                                <div class="form-group-sm">
                                    <label class="text-blue input-sm">Correo</label>
                                ...
                                <div class="form-group-sm">
                                    ...
                                    <asp:TextBox ID="txtRespuestaGeneral" runat="server" class="form-control input-sm"
                                        TextMode="MultiLine" Height="142px" Width="100%" placeholder="Respuesta"></asp:TextBox>
                                </div>
                            </div>
                        </div>
                        <div class="panel panel-default col-md-3">
                    ...
                    <div class="row-eq-height">
                        <div class="panel panel-default col-md-4">
                            <div class="panel-heading row">
                                ...
                                <asp:HiddenField ID="hdEstadoTitular" runat="server" />
                            </div>
                            <div class="panel-body form-horizontal">
                                <div class="form-group-sm">
                            ...
                            <div class="panel-body form-horizontal">
                                <div class="form-group-sm">
                                    ...
                                    <div class="centrar">
                                        ...
                                        <asp:Label ID="lblDocumentos1" runat="server" class="text-danger input-sm"></asp:Label>
                                    </div>
                                </div>
                            </div>
                        </div>
                        <div class="panel panel-default col-md-4">
                            ...
                            <div class="panel-body form-horizontal">
                                ...
                                <div class="form-group-sm" runat="server" visible="false" id="avisos1234">
                                    <div class="table-responsive centrar">
                                ...
                                <div class="form-group-sm" runat="server" visible="false" id="obs1234">
                                    <label class="control-label input-sm text-blue">
                    ...
                    <ContentTemplate>
                                ...
                                <div class="col-md-8 col-md-offset-2">
                                    <div class="form-group-sm">
                                        <label class="control-label input-sm text-blue">
                                            Ejecutivo:</label>
                                        <div class="form-inline">
                                            <asp:TextBox ID="txtEjecutivo01" runat="server" class="form-control" Width="70%"></asp:TextBox>
                        ...
                        <div class="panel-footer color-blue text-right">
                            <asp:LinkButton ID="lnkEnviarCorreo" runat="server" Visible="true" class="btn btn-default btn-sm"
                                OnClick="lnkEnviarCorreo_Click">
                                    <i class="fa fa-envelope-square fa-1x text-blue"></i>&nbsp;Enviar Correo 
                            </asp:LinkButton>
                                    ...
                                    <div class="col-md-12">
                                        <div class="table-responsive centrar">
                                            <asp:GridView ID="gvProveedor" runat="server" class="table table-bordered table-condensed table-striped input-sm"
                                                ...
                                                AutoGenerateSelectButton="true" OnRowDataBound="gvProveedor_RowDataBound" OnSelectedIndexChanged="gvProveedor_SelectedIndexChanged">
            ...
            <div class="modal-content">
                ...
                <div class="panel-body">
                    <asp:UpdatePanel ID="UpdatePanel2" runat="server">
                                    ...
                                    <div class="col-md-12">
                                        <div class="table-responsive centrar">
                                            <asp:GridView ID="gvEjecutivo" runat="server" class="table table-bordered table-condensed table-striped input-sm"
                                                ...
                                                OnRowCommand="gvEjecutivo_RowCommand" AutoGenerateSelectButton="true" OnRowDataBound="gvEjecutivo_RowDataBound"
                        ...
                        <Triggers>
                            <asp:PostBackTrigger ControlID="gvEjecutivo" />
                        </Triggers>
                    </asp:UpdatePanel>
                </div>
            </div>
        ...
        <div class="modal-dialog modal-wide modal-lg">
            <div class="modal-content panel panel-popup">
                <asp:UpdatePanel ID="UpdatePanel3" runat="server">
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="form-inline">
                                        ...
                                        <asp:TextBox ID="txtBusquedaAfi" runat="server" class="form-control input-sm" placeholder="Buscar"
                                            TabIndex="1"></asp:TextBox>
                                        <asp:LinkButton ID="lnkBuscarAfi" runat="server" class="btn btn-default btn-sm" ToolTip="Buscar"
                                            OnClick="lnkBuscarAfi_Click">
                                                <i class="fa fa-check-circle fa-1x text-blue"></i> Buscar
                                        </asp:LinkButton>
                                    </div>
                                </div>
                                ...
                                <div class="col-md-12">
                                    <div class="table-responsive centrar">
                                        <asp:GridView ID="gvAfiliado" runat="server" class="table table-bordered table-condensed table-striped input-sm"
                                            ...
                                            DataKeyNames="cod_cliente,cod_titula,categoria,afiliado,dni,fch_naci,idempresa,idUnidad_Negocio,UNIDAD_NEGOCIO"
                    ...
                    <Triggers>
                        <asp:AsyncPostBackTrigger ControlID="lnkBuscarAfi" EventName="Click" />
    ...
    <div id="PolizasCliente" class="modal modal-wide fade bs-example-modal-lg" tabindex="-1"
        ...
        <div class="modal-dialog modal-wide modal-lg">
            <div class="modal-content panel panel-popup">
                            ...
                            <div class="row" runat="server" id="detapoli" visible="false">
                                <div class="col-md-12">
                                    ...
                                    <ul class="nav nav-tabs">
                                        <li class="active success"><a href="#detalle_poliza" data-toggle="tab"><i class="fa fa-list-ul fa-1x text-danger">
                                        </i>&nbsp;Detalle</a></li>
                                        ...
                                        <li><a href="#endosos_polizas" data-toggle="tab"><i class="fa fa-file-archive-o fa-1x text-gris">
                                        </i>&nbsp;Endosos</a></li>
                                        <li><a href="#siniestros_poliza" data-toggle="tab"><i class="fa fa-bomb fa-1x text-blue">
                                        </i>&nbsp;Siniestros </a></li>
                ...
                <!--<asp:AsyncPostBackTrigger ControlID="gvPolizasCliente" EventName="RowCommand" />
                <asp:AsyncPostBackTrigger ControlID="gvPolizasCliente" EventName="PageIndexChanging" />-->
            </div>
        </div>
    </div>
                            ...
                            <div class="col-md-8 col-lg-offset-2">
                                <div runat="server" id="frmdatosAdicionalesAsegurado">
                                    <div class="form-group">
                                        <label class="text-blue input-sm">
                                            Nombres y Apellidos</label>
                                        <asp:TextBox ID="txOtrosAsegurado" runat="server" CssClass="form-control input-sm"
                                    ...
                                    <div class="col-md-2 text-center">
                                        <div class="fileinput fileinput-new" data-provides="fileinput">
                                            ...
                                            <div class="form-inline">
                                                ...
                                                <%--<a href="#" class="btn btn-default btn-sm fileinput-exists" data-dismiss="fileinput" title="Quitar"><i class="fa fa-minus-circle fa-fw"></i></a>
                                                    <asp:LinkButton ID="lnkFoto" runat="server" class="btn btn-sm btn-default" onclick="lnkFoto_Click"><i class="fa fa-upload fa-fw"></i></asp:LinkButton>--%>
                                            </div>
                                        </div>
                                        <div class="form-group-sm">
                                                    ...
                                                    <div class="panel-default">
                                                        <div class="panel-body form-horizontal">
                                                            ...
                                                            <div class="form-inline">
                                                                ...
                                                                <%--                                                                <asp:LinkButton ID="lnkBD" runat="server" class="btn btn-default btn-sm" onclick="lnkBD_Click">
                                                                    <i class="fa fa-check-circle fa-1x text-blue"></i>
                                                                </asp:LinkButton>
                                                                <asp:LinkButton ID="lnkTraer" runat="server" class="btn btn-default btn-sm" 
                                                                    Visible="false" onclick="lnkTraer_Click">
                                    ...
                                    <ContentTemplate>
                                        <div class="col-sm-12 centrar">
                                            <div class="form-inline">
                                                ...
                                                <%--                                                <asp:LinkButton ID="lnkExportarIC" runat="server" 
                                                    class="btn btn-default btn-sm pull-right" onclick="lnkExportarIC_Click">
                                    ...
                                    <ContentTemplate>
                                        <div class="col-sm-12 centrar">
                                            <div class="form-inline">
                                                ...
                                                <%--                                                    <asp:LinkButton ID="lnkExportarRecord" runat="server" 
                                                        class="btn btn-default btn-sm pull-right" onclick="lnkExportarRecord_Click">
                                ...
                                <asp:UpdatePanel ID="UpdatePanel13" runat="server">
                                    <ContentTemplate>
                                        <div class="text-center centrar">
                                            <%--                                            <div class="form-inline">
                                                <asp:Button ID="btnNuevoAviso" runat="server" Text="Nuevo" class="btn btn-primary btn-sm" onclick="btnNuevoAviso_Click" />
                                                <asp:Label ID="lblAvisoDesc" runat="server" Text="Ingresar Descripción de Aviso:" class="text-blue input-sm" Visible="False"></asp:Label>
                                                <asp:TextBox ID="txtDescripcion" runat="server" class="form-control input-sm" Visible="false"></asp:TextBox>
                                                <asp:Button ID="btnGrabando" runat="server" Text="Guardar Aviso" class="btn btn-success btn-sm" Visible="false" onclick="btnGrabando_Click" />
                                                <asp:Button ID="btnEditar" runat="server" Text="Editar Aviso" class="btn btn-success btn-sm" Visible="false" onclick="btnEditar_Click" />
                                                <asp:Button ID="btnCancelarAviso" runat="server" Text="Cancelar" class="btn btn-danger btn-sm" Visible="false" onclick="btnCancelarAviso_Click" />
                                            </div>  --%>
                                    ...
                                    <ContentTemplate>
                                        <div class="col-sm-12 centrar">
                                            <div class="form-inline">
                                                ...
                                                <%--                                                <asp:LinkButton ID="lnkExportarInformesMedicos" runat="server" 
        ...
        <div class="modal-dialog modal-lg">
            <div class="modal-content panel panel-popup">
                <div class="modal-body">
                    <div class="row-eq-height">
                        <iframe id="documentoFrame" runat="server" frameborder="0" width="100%" height="760">
                        </iframe>
                    </div>
                </div>
    ...
    <div id="RESUELTOS" class="modal fade bs-example-modal-lg" tabindex="-1" role="dialog"
        aria-labelledby="mySmallModalLabel" aria-hidden="true">
        <div class="modal-dialog modal-lg">
            <div class="modal-content panel panel-popup">
                <asp:UpdatePanel ID="UpdatePanel14" runat="server" UpdateMode="Always">
                    <ContentTemplate>
                        <div class="panel-heading text-white">
                            <div class="form-inline">
                                <i class="fa fa-pencil fa-1x"></i>Agregar Gestión Resuelto
                            </div>
                        </div>
                        <div class="panel-body color-white">
                            <div class="row text-center">
                                        ...
                                        <div class="panel-default">
                                            <div class="panel-body form-horizontal">
                                                <div class="form-group-sm">
                                                    ...
                                                    <div class="table-responsive centrar">
                                                        <asp:GridView ID="gvOrigenModalGrilla" runat="server" class="table table-bordered table-condensed input-sm"
                                                            AutoGenerateColumns="False" AllowPaging="True" DataKeyNames="ID,DESCRIP" ShowHeader="False"
                                                            OnRowCommand="gvOrigenModalGrilla_RowCommand" OnRowDataBound="gvOrigenModalGrilla_RowDataBound">
                                                            <Columns>
                                                                <asp:BoundField DataField="ID" HeaderText="" Visible="False" />
                                                                <asp:ButtonField CommandName="Seleccionar" DataTextField="DESCRIP" HeaderText="" />
                                                            </Columns>
                                        ...
                                        <div class="panel-default">
                                            <div class="panel-body form-horizontal">
                                                <div class="form-group-sm">
                                                    <label class="control-label input-sm text-blue">
                                                        (*)Saliente:</label>
                                                    <asp:HiddenField ID="hfSalienteModal" runat="server" />
                                                    <asp:HiddenField ID="hfSalienteDescripModal" runat="server" />
                                                    <div class="table-responsive centrar">
                                                        <asp:GridView ID="gvSalienteModalGrilla" runat="server" class="table table-bordered table-condensed input-sm"
                                                            AutoGenerateColumns="False" AllowPaging="True" DataKeyNames="ID,DESCRIP" ShowHeader="False"
                                                            OnRowCommand="gvSalienteModalGrilla_RowCommand" OnRowDataBound="gvSalienteModalGrilla_RowDataBound">
                                                            <Columns>
                                                                <asp:BoundField DataField="ID" HeaderText="" Visible="False" />
                                                                <asp:ButtonField CommandName="Seleccionar" DataTextField="DESCRIP" HeaderText="" />
                                                            </Columns>
                                    ...
                                    <div class="panel-default">
                                        <div class="panel-body form-horizontal">
                                            <div class="form-group-sm">
                                                <label class="control-label input-sm text-blue">
                                                    (*)Contacto:</label>
                                                <asp:TextBox ID="txtDescripcionSaliente" runat="server" class="form-control input-sm"
                                        ...
                                        <div class="panel-body form-horizontal">
                                            <div class="form-group-sm">
                                                ...
                                                <asp:TextBox ID="txtRespuesta" runat="server" class="form-control input-sm" TextMode="MultiLine"
                                                    Height="142px" Width="100%" placeholder="Respuesta"></asp:TextBox>
                                            </div>
                                            <div class="form-group-sm">
                                                <label class="control-label input-sm text-blue">
                                                    Observación:</label>
            ...
            <div class="modal-content">
                ...
                <ContentTemplate>
                    <div class="panel-heading color-red">
                        <h3 class="text-center text-white"><asp:Label ID="lblC_Contacto" runat="server" Text="Actualizar Datos"></asp:Label></h3>
                    </div>
                    <div class="panel-body">
                        <br />
                        <div class="row">
                            <div >
                                <div class="form-inlina">
                                    <strong><asp:Label ID="lblCorrectoContacto" runat="server" Text="" CssClass="control-label input-sm text-success"></asp:Label></strong>
                                    <strong><asp:Label ID="lblErrorContacto" runat="server" Text="" CssClass="control-label input-sm text-danger"></asp:Label></strong>
                                </div>
                            </div>
                            <div class="col-md-12">
                                <div class="col-md-4">                                    
