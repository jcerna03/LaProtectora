<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="FichaPersonal.aspx.cs" Inherits="SFW.Web.FichaPersonal" %>
  ...
  <tr>
    <td>
      <table width="650" border="0" cellspacing="0" cellpadding="0" class="Estilo2">
        <tr>
            <td width="121" align="center" style="border-left:1px solid #000000;border-top:1px solid #000000;">
                 <asp:Image ID="Image2" runat="server" width="104" ImageUrl="~/image/Logo.png"/>
            </td>
            <td width="385" align="center" style="border-right:1px solid #000000;border-top:1px solid #000000;">&nbsp;LA PROTECTORA CORREDORES DE SEGUROS</td>
        </tr>
      </table>
      <table width="100%" border="0" cellspacing="0" cellpadding="0">
        <tr>
            <td width="121" align="center" style="border-left:1px solid #000000;">
              <asp:Image ID="Image1" runat="server" width="104" BorderColor="Black" BorderStyle="Solid" BorderWidth="1"  />
            </td>
            <td width="385" align="center" style="border-right:1px solid #000000;">
            <table width="84%" border="0" cellspacing="0" cellpadding="0" class="Estilo5">
                <tr>
                <td width="50%" align="center" style="border-top:1px solid #000000; border-left:1px solid #000000; border-right:1px solid #000000; border-bottom:1px solid #000000;">
                    INSCRIPCIÓN&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<asp:CheckBox ID="CheckBox3" runat="server" />
                </td>
                <td width="50%" align="center" style="border-top:1px solid #000000; border-right:1px solid #000000; border-bottom:1px solid #000000;">
                    REINSCRIPCIÓN&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<asp:CheckBox ID="CheckBox4" runat="server" />
                </td>
                </tr>
                <tr>
                <td align="center" style="border-left:1px solid #000000; border-right:1px solid #000000; border-bottom:1px solid #000000;">
                    CAMBIO DE PLAN&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<asp:CheckBox ID="CheckBox5" runat="server" />
                </td>
                <td align="center" style="border-right:1px solid #000000; border-bottom:1px solid #000000;">
                    EXCLUSIÓN&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &nbsp;<asp:CheckBox ID="CheckBox6" runat="server" />
                </td>
                </tr>
            </table>
            </td>
      ...
      <table width="650" border="0" cellspacing="0" cellpadding="0">
        <tr >
          <td height="40" align="center" valign="middle" class="Estilo1" style="border-right:1px solid #000000;border-left:1px solid #000000;">FICHA DE DATOS PERSONALES</td>
        </tr>
      </table>
      <table width="650" border="0" cellspacing="0" cellpadding="0">
        <tr>
      ...
      <table width="650" border="0" cellspacing="0" cellpadding="0" class="Estilo3">
        <tr>
            <td style="border-left:1px solid #000000; border-right:1px solid #000000; border-bottom:1px solid #000000;">
                &nbsp;Centro de Costo: <asp:Label ID="lblcentrodecosto" runat="server"></asp:Label>
            </td>
      ...
      <table width="650" border="0" cellspacing="0" cellpadding="0" class="Estilo3">
        <tr>
          <td style="border-left:1px solid #000000; border-right:1px solid #000000; border-bottom:1px solid #000000;">&nbsp;Fecha Alta:&nbsp;<asp:Label ID="lblfechadealta" runat="server"></asp:Label></td>
