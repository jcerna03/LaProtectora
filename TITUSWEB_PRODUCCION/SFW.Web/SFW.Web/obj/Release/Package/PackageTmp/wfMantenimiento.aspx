...
<body>
    <form id="form1" runat="server" method="post" autocomplete="off">
            ...
            <div class="col-lg-12">
                <div class="panel panel-blue sombra02">
                    <div class="panel-heading text-center">
                        <h4>Sistema de Administración de Datos de Afiliados TituFoxWeb V.10.08.16<label style="visibility: hidden;">----</label></h4>
                    </div>
                    <div class="panel-body">
                        <div class="col-md-12">
                            <div class="text-center">
                                ...
                                <strong>
                                    <asp:Label ID="lblverificacion2" runat="server" class="text-success"></asp:Label></strong>
                                <div runat="server" id="duplicado" class="alert alert-danger" visible="false">
                                    <button type="button" class="close" data-dismiss="alert">
                                        <span aria-hidden="true">×</span> <span class="sr-only">Close</span>
                                    </button>
                                    <h4>¡¡Ocurrió un error de duplicidad</h4>
                                    <p>
                                        <strong>
                            ...
                            <div class="pull-right">
                                <asp:LinkButton ID="lnkAlertas" runat="server" class="btn btn-sm" ToolTip="Alertas"
                                    ...
                                    <asp:Image ID="Image2" runat="server" ImageUrl="~/image/alertas.gif" Height="10px"
                                        Width="10px" />
                                    <strong>
                                        <asp:Label ID="lblTotal" runat="server" class="text-danger"></asp:Label></strong>
                                </asp:LinkButton>
                        ...
                        <div class="col-sm-12">
                            ...
                            <div class="row">
                                <div class="col-md-12 table-responsive">
                                    <asp:GridView ID="GridView2" runat="server" AutoGenerateColumns="False" DataKeyNames="categoria,cod_titula,fch_baja,cod_cliente,dni,cod_cliente2,clasif"
                                        AllowPaging="True" class="table table-bordered table-condensed table-striped input-sm"
                                        TabIndex="2" OnPageIndexChanging="GridView2_PageIndexChanging" OnRowCommand="GridView2_RowCommand" OnRowDataBound="GridView2_RowDataBound">
                                        <Columns>
                                            ...
                                            <asp:BoundField DataField="Reporte_ln" HeaderText="SUSALUD" HtmlEncode="false" />
                                        </Columns>
                                            ...
                                            <div class="row">
                                                <div class="col-md-2 text-center">
                                                    ...
                                                    <div class="form-group-sm">
                                                        ...
                                                        <div class="text-justify" style="display: none;">
                                                            <asp:RadioButtonList ID="rblAfiliacion" runat="server" TextAlign="Right">
                                                                <asp:ListItem Value="">Caso Normal</asp:ListItem>
                                                                <asp:ListItem Value="2">Afiliado sin afiliación</asp:ListItem>
                                                                <asp:ListItem Value="3">Afiliado Fallecido</asp:ListItem>
                                                                <asp:ListItem Value="4">Afiliado Inexistente</asp:ListItem>
                                                                <asp:ListItem Value="5">Titular Inexistente </asp:ListItem>
                                                                <asp:ListItem Value="9">No Afiliado/Afiliación</asp:ListItem>
                                                                <asp:ListItem Value="10">Baja Afiliacion</asp:ListItem>
                                                            </asp:RadioButtonList>
                                                            <hr />
                                                            <asp:RadioButtonList ID="rblAfiliacion2" runat="server" TextAlign="Right">
                                                                <asp:ListItem Value="">Caso Normal</asp:ListItem>
                                                                <asp:ListItem Value="6">01||Reg.Afiliación</asp:ListItem>
                                                                <asp:ListItem Value="7">11||Act.Afiliado</asp:ListItem>
                                                                <asp:ListItem Value="8">12||Act.Afiliación</asp:ListItem>
                                                            </asp:RadioButtonList>
                                                        </div>
                                                    </div>
                                                </div>
                                                                ...
                                                                <div class="panel-default">
                                                                    <div class="panel-body form-horizontal">
                                                                        ...
                                                                        <div class="form-group-sm">
                                                                            ...
                                                                            <asp:HiddenField ID="planHidden" runat="server" />
                                                                        </div>
                                                                        <div class="form-group-sm">
                                                                            <label class="control-label input-sm text-blue">
                                                                ...
                                                                <asp:UpdateProgress ID="updateProgress5" runat="server">
                                                                    <ProgressTemplate>
                                                                        <div style="position: fixed; text-align: center; height: 100%; width: 100%; top: 0; right: 0; left: 0; z-index: 9999999; background-color: #fff; opacity: 0.7;">
                                                                            <asp:Image ID="imgUpdateProgress23" runat="server" ImageUrl="~/image/loading1.gif"
        ...
        <asp:HiddenField runat="server" ID="hfClienteGrilla" />
                ...
                <div class="modal-content panel panel-popup">
                    ...
                    <div class="panel-body">
                        <asp:UpdatePanel ID="UpdatePanel6" runat="server" UpdateMode="Always">
                            <ContentTemplate>
                                <div class="col-md-12 table-responsive">
                                    <asp:GridView ID="gvGrupoFamiliar" runat="server" AutoGenerateColumns="False" DataKeyNames="cod_cliente,cod_titula,categoria,clasif"
                                        class="table table-bordered table-condensed table-striped input-sm" OnRowCommand="gvGrupoFamiliar_RowCommand" OnRowDataBound="gvGrupoFamiliar_RowDataBound">
                                        <Columns>
                                            <asp:ButtonField CommandName="Editar" Text="Editar" />
                                            <asp:BoundField DataField="cod_cliente" HeaderText="CLIENTE" SortExpression="#.POLIZA" />
                                            <asp:BoundField DataField="cod_cliente2" HeaderText="#.POLIZA" SortExpression="#.POLIZA" Visible="false" />
                                            <asp:BoundField DataField="cod_titula" HeaderText="CO.TITU" SortExpression="CO.TITU" />
                                            <asp:BoundField DataField="dni" HeaderText="DNI" SortExpression="DNI" />
        ...
        <div id="HISTORIAL" class="modal modal-wide fade bs-example-modal-lg" tabindex="-1"
            role="dialog" aria-labelledby="mySmallModalLabel" aria-hidden="true">
            <div class="modal-dialog modal-lg">
                <div class="modal-content panel panel-popup">
                    <div class="panel-heading color-blue text-white">
                        <div class="form-inline">
                            <i class="fa fa-calendar-o fa-1x"></i>HISTORIAL DE PERIODOS
                        </div>
                    </div>
                    <div class="panel-body">
                            ...
                            <ContentTemplate>
                                <div class="col-md-12 table-responsive">
                                    <asp:GridView ID="gvHistorial" runat="server" AutoGenerateColumns="False"
                                        class="table table-bordered table-condensed table-striped input-sm" EmptyDataText="No tiene historial">
                                        <Columns>
                                            <asp:BoundField DataField="cod_cliente" HeaderText="COD_CLIENTE" SortExpression="COD_CLIENTE" />
                                            <asp:BoundField DataField="cod_titula" HeaderText="COD_TITULA" SortExpression="COD_TITULA" />
                                            <asp:BoundField DataField="categoria" HeaderText="CATEGORIA" SortExpression="CATEGORIA" />
                                            <asp:BoundField DataField="alta" HeaderText="F.ALTA" SortExpression="F.ALTA" />
                                            <asp:BoundField DataField="baja" HeaderText="F.BAJA" SortExpression="F.BAJA" />
                                            <asp:BoundField DataField="registro" HeaderText="F.REGISTRO" SortExpression="F.REGISTRO" />
                                            <asp:BoundField DataField="plan" HeaderText="PLAN" SortExpression="PLAN" />
                                        </Columns>
                                    </asp:GridView>
                                    <br />
                                    <strong>
                                        <asp:Label ID="Label11" runat="server" class="text-success"></asp:Label></strong>
                                    <strong>
                                        <asp:Label ID="Label12" runat="server" class="text-danger"></asp:Label></strong>
                                    <strong>
                                        <asp:Label ID="Label14" runat="server" class="text-danger"></asp:Label></strong>
                                </div>
                            </ContentTemplate>
                            <Triggers>
                                <asp:PostBackTrigger ControlID="gvHistorial" />
                            </Triggers>
                        </asp:UpdatePanel>
                    </div>
                    <div class="panel-footer color-blue text-white text-center">
                        <asp:LinkButton ID="lnkCerrarHistorial" OnClick="lnkCerrarHistorial_Click" runat="server" class="btn btn-default btn-sm" ToolTip="Regresar"
                            aria-hidden="true">
                        <i class="fa fa-sign-out fa-1x text-blue"></i> Cerrar
                        </asp:LinkButton>
                    </div>
